<?php
/**
 * The main basic template file converted to car rental website
 *
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="<?php echo get_template_directory_uri()?>/img/carousel-2.jpg" class="img-fluid w-100" alt="First slide"/>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <img src="<?php echo get_template_directory_uri()?>/img/features-img.png" class="img-fluid w-100" style="object-fit: cover;" alt="Img">
                    </div>
                    <div class="col-xl-4">
                        <div class="row gy-4 gx-0">
                            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="container py-5">
                <div class="row g-5">
                        ...
                        <div class="about-item">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        <div class="about-icon mb-4">
                                            <img src="<?php echo get_template_directory_uri()?>/img/about-icon-1.png" class="img-fluid w-50 h-50" alt="Icon">
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        <div class="about-icon mb-4">
                                            <img src="<?php echo get_template_directory_uri()?>/img/about-icon-2.png" class="img-fluid h-50 w-50" alt="Icon">
                                        </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-7">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri()?>/img/attachment-img.jpg" class="img-fluid rounded-circle border border-4 border-secondary" style="width: 100px; height: 100px;" alt="Image">
                                        <div class="ms-4">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-img">
                            <div class="img-1">
                                <img src="<?php echo get_template_directory_uri()?>/img/about-img.jpg" class="img-fluid rounded h-100 w-100" alt="">
                            </div>
                            <div class="img-2">
                                <img src="<?php echo get_template_directory_uri()?>/img/about-img-1.jpg" class="img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container pb-5">
                ...
                <div class="categories-carousel owl-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?php echo get_template_directory_uri()?>/img/car-1.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?php echo get_template_directory_uri()?>/img/car-2.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?php echo get_template_directory_uri()?>/img/car-3.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?php echo get_template_directory_uri()?>/img/car-4.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/blog-1.jpg" class="img-fluid rounded-top w-100" alt="Image">
                            </div>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/blog-2.jpg" class="img-fluid rounded-top w-100" alt="Image">
                            </div>
                            <div class="blog-content rounded-bottom p-4">
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/blog-3.jpg" class="img-fluid rounded-top w-100" alt="Image">
                            </div>
                            <div class="blog-content rounded-bottom p-4">
        ...
        <div class="container-fluid banner pb-5 wow zoomInDown" data-wow-delay="0.1s">
            <div class="container pb-5">
                <div class="banner-item rounded">
                    <img src="<?php echo get_template_directory_uri()?>/img/banner-1.jpg" class="img-fluid rounded w-100" alt="">
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item p-4 pt-0">
                            <div class="team-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/team-1.jpg" class="img-fluid rounded w-100" alt="Image">
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item p-4 pt-0">
                            <div class="team-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/team-2.jpg" class="img-fluid rounded w-100" alt="Image">
                            </div>
                            <div class="team-content pt-4">
                                <h4>MARTIN DOE</h4>
                                <p>Profession</p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item p-4 pt-0">
                            <div class="team-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/team-3.jpg" class="img-fluid rounded w-100" alt="Image">
                            </div>
                            <div class="team-content pt-4">
                                <h4>MARTIN DOE</h4>
                                <p>Profession</p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item p-4 pt-0">
                            <div class="team-img">
                                <img src="<?php echo get_template_directory_uri()?>/img/team-4.jpg" class="img-fluid rounded w-100" alt="Image">
                            </div>
                            <div class="team-content pt-4">
                                <h4>MARTIN DOE</h4>
                                <p>Profession</p>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-inner p-4">
                            <img src="<?php echo get_template_directory_uri()?>/img/testimonial-1.jpg" class="img-fluid" alt="">
                            <div class="ms-4">
                                <h4>Person Name</h4>
                                <p>Profession</p>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-inner p-4">
                            <img src="<?php echo get_template_directory_uri()?>/img/testimonial-2.jpg" class="img-fluid" alt="">
                            <div class="ms-4">
                                <h4>Person Name</h4>
                                <p>Profession</p>
                                <div class="d-flex text-primary">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-inner p-4">
                            <img src="<?php echo get_template_directory_uri()?>/img/testimonial-3.jpg" class="img-fluid" alt="">
                            <div class="ms-4">
                                <h4>Person Name</h4>
                                <p>Profession</p>
                                <div class="d-flex text-primary">
